...
function GetBooking() {
    let url = 'https://api.sheety.co/41fc605865c2b3b90427c390bc428207/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/41fc605865c2b3b90427c390bc428207/bookingApp/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
